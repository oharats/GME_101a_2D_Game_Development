...
public class Boss_Cannons_M : MonoBehaviour
{
    [SerializeField]
    ...
    [SerializeField]
    private GameObject _damageMid1;
    [SerializeField]
    private GameObject _damageMid2;
    ...
    void Start()
    {
        _damageMid1.SetActive(false);
        _damageMid2.SetActive(false);
    ...
    private void OnTriggerEnter2D(Collider2D other)
    {
        ...
        if (_hitCount == 1)
        {
            _damageMid1.SetActive(true);
        }
        else if (_hitCount <= 0)
        {
            _damageMid2.SetActive(true);
            _audioSource.Play();
            _isDown = true;
        }
